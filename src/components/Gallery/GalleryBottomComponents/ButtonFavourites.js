...
const ButtonFavourites = ({ toFavourites, isFavourite }) => {
  if (!isFavourite) {
    return (
      <div className="bottom-button-to-favourites" onClick={toFavourites}>
        <p>В избранное</p>
      </div>
    );
  }
  return (
    <div className="bottom-button-from-favourites" onClick={toFavourites}>
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
